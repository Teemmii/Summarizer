...
def generate_readout(specialty, name):
    template = """ 
        As a read out manager, please come up with a simple read out (100 words) of key clinical trails stages by pharmaceutical companys in the last one year based on specialties
        {specialties}
